/* ###################################################################
**     Filename    : Events.c
**     Project     : FDRM_KL05Z_blinkLED
**     Processor   : MKL05Z32VFM4
**     Component   : Events
**     Version     : Driver 01.00
**     Compiler    : GNU C Compiler
**     Date/Time   : 2014-12-25, 23:17, # CodeGen: 0
**     Abstract    :
  ...
  if (TSS1_cKey0.DynamicStatus.Movement)
  {
    if (TSS1_cKey0.Events.Touch)
    {
      if (!(TSS1_cKey0.Events.InvalidPos))
      {
        ...
        LEDR_Put(TSS1_cKey0.Position<=20);
        LEDG_Put(TSS1_cKey0.Position>20 && TSS1_cKey0.Position<=40);
        LEDB_Put(TSS1_cKey0.Position>40 && TSS1_cKey0.Position<=64);
