...
**     Date/Time   : 2015-11-08, 17:19, # CodeGen: 1
**     Abstract    :
**          Implements busy waiting routines.
**     Settings    :
**          Component name                                 : WAIT1
**          Manual Clock Values                            : Enabled
**            CPU_BUS_CLK_HZ                               : 8000000
**            CPU_BUS_CLK_HZ_HIGH                          : 8000000
**            CPU_BUS_CLK_HZ_LOW                           : 4000000
**            CPU_BUS_CLK_HZ_SLOW                          : 1000000
...
#define CPU_BUS_CLK_HZ          8000000UL    /*!< CPU clock frequency (normal operation) */

#undef CPU_BUS_CLK_HZ_HIGH                   /* if already defined in "Cpu.h" */
#define CPU_BUS_CLK_HZ_HIGH     8000000UL    /*!< CPU clock frequency in high speed mode */

#undef CPU_BUS_CLK_HZ_SLOW                   /* if already defined in "Cpu.h" */
#define CPU_BUS_CLK_HZ_SLOW     1000000UL    /*!< CPU clock frequency in low speed mode */

#undef CPU_BUS_CLK_HZ_LOW                    /* if already defined in "Cpu.h" */
#define CPU_BUS_CLK_HZ_LOW      4000000UL    /*!< CPU clock frequency in slow speed mode */
